				...
				<form>
					...
					<div class="modal-body">					
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="nomor_rekam_medis" required></input>
						</div>
						<div class="form-group">
			...
			<div class="modal-content">
				<form>
                    ...
                    <label>Nomor Pasien</label>
							<input type="text" class="form-control" name="nomor_pasien" required>
						</div>				
						<div class="form-group">
							<label>Nama</label>
							<input type="text" name="nama" required>
